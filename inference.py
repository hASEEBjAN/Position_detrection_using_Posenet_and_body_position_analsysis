...
def annotate_image(file_path, coordinates):
    ...
    image_font = ImageFont.truetype(r'C:\Users\System-Pc\Desktop\arial.ttf', int(image_width/10))
    ...
    image = helpers.display_position(image, image_draw, image_coordinates, image_font)
...
def annotate_video(file_path, coordinates):
    ...
    while True:
        try:
            ...
            image = helpers.display_position(image, image_draw, image_coordinates)
